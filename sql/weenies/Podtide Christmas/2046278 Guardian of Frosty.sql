...
VALUES (2046278, 'ace2046278-guardianoffrosty', 10, '2021-12-24 15:12:22') /* Creature */;
...
VALUES (2046278,   1,       5) /* HeartbeatInterval */
     ...
     , (2046278,  13,    0.68) /* ArmorModVsSlash */
     , (2046278,  14,    0.42) /* ArmorModVsPierce */
     , (2046278,  15,    0.68) /* ArmorModVsBludgeon */
     , (2046278,  16,     0.1) /* ArmorModVsCold */
     , (2046278,  17,     0.3) /* ArmorModVsFire */
     , (2046278,  18,    0.68) /* ArmorModVsAcid */
     , (2046278,  19,    0.68) /* ArmorModVsElectric */
...
VALUES (2046278,  6, 0, 3, 0, 400, 0, 0) /* MeleeDefense        Specialized */
     , (2046278,  7, 0, 3, 0, 500, 0, 0) /* MissileDefense      Specialized */
...
VALUES (2046278,  0,  8,  0,    0,  650,  442,  273,  442,   65,  195,  442,  442,  650, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (2046278,  1,  8,  0,    0,  650,  442,  273,  442,   65,  195,  442,  442,  650, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (2046278,  2,  8,  0,    0,  650,  442,  273,  442,   65,  195,  442,  442,  650, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (2046278,  3,  8,  0,    0,  650,  442,  273,  442,   65,  195,  442,  442,  650, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (2046278,  4,  8,  0,    0,  650,  442,  273,  442,   65,  195,  442,  442,  650, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (2046278,  5,  8, 220,  0.5,  650,  442,  273,  442,   65,  195,  442,  442,  650, 2,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0) /* Hand */
     , (2046278,  6,  8,  0,    0,  100,   68,   42,   68,   10,   30,   68,   68,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (2046278,  7,  8,  0,    0,  650,  442,  273,  442,   65,  195,  442,  442,  650, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (2046278,  8,  8, 220,  0.5,  650,  442,  273,  442,   65,  195,  442,  442,  650, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
...
VALUES (2046278, 2, 46282,  1, 0, 0, False) /* Create  (46282) for Wield */;
