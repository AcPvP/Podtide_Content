...
VALUES (2232483, 'ace2232483-frosty', 10, '2021-12-24 04:27:24') /* Creature */;
...
VALUES (2232483,   1,       5) /* HeartbeatInterval */
     ...
     , (2232483,  13,       1) /* ArmorModVsSlash */
     , (2232483,  14,     1.4) /* ArmorModVsPierce */
     , (2232483,  15,       1) /* ArmorModVsBludgeon */
     , (2232483,  16,     1.4) /* ArmorModVsCold */
     , (2232483,  17,     0.3) /* ArmorModVsFire */
     , (2232483,  18,       1) /* ArmorModVsAcid */
     , (2232483,  19,       1) /* ArmorModVsElectric */
...
VALUES (2232483,  6, 0, 3, 0, 540, 0, 0) /* MeleeDefense        Specialized */
     , (2232483,  7, 0, 3, 0, 500, 0, 0) /* MissileDefense      Specialized */
     , (2232483, 14, 0, 3, 0,  70, 0, 0) /* ArcaneLore          Specialized */
     , (2232483, 15, 0, 3, 0, 380, 0, 0) /* MagicDefense        Specialized */
...
VALUES (2232483,  0,  8,  0,    0,  350,  301,  350,  350,  350,  350,  350,  350,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (2232483,  1,  8,  0,    0,  350,  301,  350,  350,  350,  350,  350,  350,    0, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (2232483,  2,  8,  0,    0,  350,  301,  350,  350,  350,  350,  350,  350,    0, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (2232483,  3,  8,  0,    0,  350,  301,  350,  350,  350,  350,  350,  350,    0, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (2232483,  4,  8,  0,    0,  350,  301,  350,  350,  350,  350,  350,  350,    0, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (2232483,  5,  8, 215,  0.5,  650,  559,  650,  650,  650,  650,  650,  650,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     , (2232483,  6,  8,  0,    0,  350,  301,  350,  350,  350,  350,  350,  350,    0, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (2232483,  7,  8,  0,    0,  350,  301,  350,  350,  350,  350,  350,  350,    0, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (2232483,  8,  8, 215,  0.5,  650,  559,  650,  650,  650,  650,  650,  650,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
