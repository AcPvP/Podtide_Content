...
VALUES (2332483, 'ace2332483-frosty', 10, '2021-12-25 03:17:54') /* Creature */;
...
VALUES (2332483,   1,       5) /* HeartbeatInterval */
     ...
     , (2332483,  13,     0.3) /* ArmorModVsSlash */
     , (2332483,  14,     0.3) /* ArmorModVsPierce */
     , (2332483,  15,     0.3) /* ArmorModVsBludgeon */
     , (2332483,  16,     0.1) /* ArmorModVsCold */
     , (2332483,  17,     0.4) /* ArmorModVsFire */
     , (2332483,  18,     0.3) /* ArmorModVsAcid */
     , (2332483,  19,     0.3) /* ArmorModVsElectric */
...
VALUES (2332483,  6, 0, 3, 0, 500, 0, 0) /* MeleeDefense        Specialized */
     , (2332483,  7, 0, 3, 0, 600, 0, 0) /* MissileDefense      Specialized */
     , (2332483, 12, 0, 3, 0, 400, 0, 0) /* ThrownWeapon        Specialized */
     , (2332483, 13, 0, 3, 0, 400, 0, 0) /* UnarmedCombat       Specialized */
     , (2332483, 14, 0, 3, 0,  70, 0, 0) /* ArcaneLore          Specialized */
     , (2332483, 15, 0, 3, 0, 320, 0, 0) /* MagicDefense        Specialized */
...
VALUES (2332483,  0,  8,  0,    0,  650,  442,  273,  442,   65,  295,  442,  442,  650, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (2332483,  1,  8,  0,    0,  650,  442,  273,  442,   65,  295,  442,  442,  650, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (2332483,  2,  8,  0,    0,  650,  442,  273,  442,   65,  295,  442,  442,  650, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (2332483,  3,  8,  0,    0,  650,  442,  273,  442,   65,  295,  442,  442,  650, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (2332483,  4,  8,  0,    0,  650,  442,  273,  442,   65,  295,  442,  442,  650, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (2332483,  5,  8, 220,  0.5,  650,  442,  273,  442,   65,  295,  442,  442,  650, 2,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0) /* Hand */
     , (2332483,  6,  8,  0,    0,  650,  442,  273,  442,   65,  295,  442,  442,  650, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (2332483,  7,  8,  0,    0,  650,  442,  373,  442,   65,  295,  442,  442,  650, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (2332483,  8,  8, 220,  0.5,  650,  442,  273,  442,   65,  295,  442,  442,  650, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
